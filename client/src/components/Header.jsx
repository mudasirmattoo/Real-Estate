      ...
      <div className="flex justify-between items-center relative">
        ...
        <form className="bg-gray-800 rounded-lg p-3 flex items-center">
          <input
            type="text"
            placeholder="Search ..."
            className="bg-transparent outline-none text-white w-44 sm:w-96"
          />
          <FaSearch className="text-violet-600" />
        </form>
        <div className="sm:hidden">
          <FaBars
            className="text-violet-600 font-bold text-2xl cursor-pointer"
            onClick={toggleMenu}
          />
          {isMenuOpen && (
        ...
        <ul className="hidden sm:flex space-x-10 text-2xl text-violet-600 ">
          <Link to="/">
            <li className="hover:text-violet-300">Home</li>
          </Link>
          <Link to="/about">
            <li className="hover:text-violet-300">About</li>
          </Link>
          <Link to="/sign-in">
            <li className="hover:text-violet-300">Sign In</li>
          </Link>
        </ul>
      </div>
    </header>
